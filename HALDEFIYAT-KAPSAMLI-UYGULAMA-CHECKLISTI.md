...
- [ ] E47 Haftalık rapor üreticisi şablon borcu (2026-08-18 tespiti): üretilen taslak yayın konseptiyle uyuşmuyor, her hafta elle sıfırdan yazılıyor (taslak 1.926 krk düz metin ↔ yayınlanan ~9.200 krk editoryal HTML). 6 iş + 3 guardrail brief'te: `docs/codex-briefs/haftalik-rapor-uretici-sablonu.md` (endeks-öncelikli başlık, 47→60 krk meta title, anlamsız kategori ortalaması, tr-TR sayı/tarih biçimi, HTML iskeleti, geçen-hafta takip listesi otomasyonu). Yayın kapısı (insan onayı) değişmez.

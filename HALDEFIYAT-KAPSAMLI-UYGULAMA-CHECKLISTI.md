...
- [X] S7 **Kayseri ETL kaynağı.** — **ZATEN ÇALIŞIYOR, DOKÜMAN BAYATMIŞ** (2026-08-31 doğrulaması): son 30 günde **3.460 fiyat satırı / 30 farklı gün**, son veri bugün; canlı `/hal/kayseri-hal` sayfasında 116 ürün listeleniyor. 15 koşunun tamamı `partial` — bu hata değil, karantina kuralının bazı satırları tutması. AngularJS/AJAX reverse-engineering işi gerekmiyor; CLAUDE.md'deki iki yanlış not (bekleyen iş listesi + Sorunlu Kaynaklar tablosu) düzeltildi. **Not:** "kayseri hal fiyatları" sorgusundaki düşük CTR (1.098 gösterim / %0,73) veri eksikliği DEĞİL — S20 incelemesinde görülen SERP rekabeti.

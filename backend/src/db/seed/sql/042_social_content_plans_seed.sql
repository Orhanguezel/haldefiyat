...
VALUES
  (UUID(), 'twitter', 'morning', 0, 9, 0, 'daily_movers',  'veri',   'Her gün 09:00: en çok artan/düşen ürünler', 'post', 0, 1, 1, NOW(), NOW()),
  (UUID(), 'twitter', 'popular', 0, 13, 0, 'staples',      'veri',   'Her gün 13:00: popüler ürün fiyatları (domates, biber, mevsim meyveleri…)', 'post', 0, 1, 2, NOW(), NOW()),
  (UUID(), 'twitter', 'weekly',  7, 19, 0, 'weekly_index', 'analiz', 'Haftalık: fiyat analizi özeti (taslak)', 'post', 0, 1, 3, NOW(), NOW())

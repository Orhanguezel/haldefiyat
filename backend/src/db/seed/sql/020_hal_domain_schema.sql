...
CREATE TABLE IF NOT EXISTS `hf_markets` (
  ...
  `address`       VARCHAR(255)     DEFAULT NULL COMMENT 'Halin dogrulanmis fiziki adresi/konumu',
  `phone`         VARCHAR(64)      DEFAULT NULL COMMENT 'Resmi hal mudurlugu telefonu',
  `founded`       VARCHAR(32)      DEFAULT NULL COMMENT 'Kurulus yili',
  `hours`         VARCHAR(64)      DEFAULT NULL COMMENT 'Satis/calisma saatleri',
...
CREATE TABLE IF NOT EXISTS `hf_products` (
  ...
  KEY `hf_products_family_idx` (`family_slug`),

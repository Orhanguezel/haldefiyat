...
export const env = {
  ...
  // Sosyal medya (X/Twitter) — haldefiyat sosyali artik tamamen hal'de.
  ...
  ETL: {
    ...
    // Zamanlanmış yayın kontrolü — her 10 dakikada bir due taslakları yayınlar
    scheduledPublishSchedule: process.env.SCHEDULED_PUBLISH_CRON || "*/10 * * * *",

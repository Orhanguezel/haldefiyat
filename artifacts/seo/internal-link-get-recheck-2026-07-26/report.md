...
- 2xx: **268**; nihai 3xx: **0**
- 4xx: **11**; 5xx: **0**; ağ hatası: **0**
- Redirect içeren hedef: **212**
...
- `https://haldefiyat.com/urun/elma-grannysmith` — HTTP 404; redirect=0; kaynak: https://haldefiyat.com/urun/elma
- `https://haldefiyat.com/urun/elma-gransimit` — HTTP 404; redirect=0; kaynak: https://haldefiyat.com/urun/elma
...
- `https://haldefiyat.com/urun/havuc-diger` — HTTP 404; redirect=0; kaynak: https://haldefiyat.com/urun/havuc
...
- `https://haldefiyat.com/urun/kabak-mini` — HTTP 404; redirect=0; kaynak: https://haldefiyat.com/urun/kabak
...
- `https://haldefiyat.com/urun/kavun-normal` — HTTP 404; redirect=0; kaynak: https://haldefiyat.com/urun/kavun
...
- `https://haldefiyat.com/urun/patates-kumpir` — HTTP 404; redirect=0; kaynak: https://haldefiyat.com/urun/patates

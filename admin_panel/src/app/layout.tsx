...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const appleIconUrl = branding.media.site_apple_touch_icon || '/apple-touch-icon.png';
  const ogImageUrl = branding.media.site_og_default_image || branding.media.site_logo || '/logo.png';

  return {
    metadataBase: new URL(branding.meta.og_url || 'https://admin.haldefiyat.com'),

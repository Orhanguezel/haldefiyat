...
export const adminNavConfig: AdminNavConfigGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'firms', url: '/admin/firmalar', icon: Building2 },
      { key: 'firm_leads', url: '/admin/talepler', icon: Bell },
      { key: 'listings', url: '/admin/ilanlar', icon: Package },

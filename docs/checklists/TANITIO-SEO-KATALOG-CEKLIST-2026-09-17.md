...
| D13 | OG kapaklarında logo okunmuyordu (katalogda yok, gözle bulundu) | 16 editoryal kapakta koyu zemine **açık-zemin logosu** basılıydı; "halde"/".com" lacivert. Ölçülen WCAG kontrastı **1,19:1** (1,00 = aynı renk) | GERÇEK, kapatıldı | Aynı görseller koyu-tema logosuyla yeniden üretildi → **12,33:1**. Dosyalar artık repoda (`frontend/public/og-pages/`), seed de aynı yolu gösterir. 31 Ağu'da aynı kusur görülüp seed `/og/default`'a alınmış ama **canlıya hiç uygulanmamıştı**; üstelik o çözüm A6'yı tetikliyordu | — | ✅ |

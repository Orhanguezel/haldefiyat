...
## 1b. İKİNCİ OLAY — CANLI DONMA (2026-07-07'den beri, ACİL)

Yukarıdaki 2023-2026 olayı tarihsel. **Ayrı ve devam eden bir donma daha var**, soğan analizi hazırlanırken bulundu (2026-07-20). 7 Temmuz 2026'dan bu yana:

| Hal | Donmuş seri oranı (7–20 Tem) |
|---|---|
| Demre / Kumluca / Gazipaşa / Finike | %100 (dördü de) |
| Kütahya | %80 |
| Yalova | %73 |
| Konya | %71 |
| Kayseri | %57 |
...
Somut kanıt (kuru soğan): **Kayseri 14 gündür 110,00 ₺**, **Konya 14 gündür 11,50 ₺** — ikisi de 2026-07-07'de dondu, aynı gün. Konya 6 Temmuz'da 32,50 ₺'ydi.

**Ek bulgu — ürün eşleme hatası:** Kayseri'de 6 Temmuz kaydı `sogan-kuru-arpacik` (arpacık soğan, farklı ve pahalı ürün) ve fiyat oradan `sogan-kuru`'ya taşınmış görünüyor. Donma + yanlış eşleme birlikte 110 ₺'lik sahte bir ulusal girdi üretiyor.

- [ ] 2026-07-07'de ne değişti? (deploy, ETL revizyonu, kaynak site değişikliği) — `hf_etl_runs` ve git log 07-06/07-07 arası incelensin
- [ ] Antalya grubu (Demre/Kumluca/Gazipaşa/Finike = batiakdeniztv) haftalık mı yayınlıyor? Öyleyse %100 normal olabilir — **doğrula, varsayma**
- [ ] Kayseri arpacık→kuru soğan eşleme hatası düzeltilsin
- [ ] Faz 4'teki donma dedektörü bu olay yüzünden **öncelik kazandı** — 3 yıl değil, 2 hafta içinde yakalanmalıydı

> **Etki değerlendirmesi (yapıldı):** 2026-07-20 bülteninde soğan +%17,4 yayınlandı; donmuş seriler hariç +%15,2. Medyan dayandığı için sapma önemsiz. Soğan analiz yazısında donmuş seriler ve agregatör elenerek hesaplandı.

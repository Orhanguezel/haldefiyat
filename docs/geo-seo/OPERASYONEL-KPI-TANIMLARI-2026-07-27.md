...
| CWV-good URL oranı | URL-level CrUX alan verisinde üç metriği good olan URL / yeterli alan verisi olan ölçülen URL | Yetersiz URL-level alan verisi; oran hesaplanmadı | Veri oluştuğunda ≥%90; veri yokluğu başarı sayılmaz | CrUX URL-level / PSI API | Frontend/Performans | Aylık |

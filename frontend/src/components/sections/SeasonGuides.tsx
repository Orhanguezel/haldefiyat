      ...
      <div className="grid gap-4 md:grid-cols-3">
        {REHBER_LIST.map((guide) => (
          <Link
            ...
            className="group rounded-2xl border border-(--color-border) bg-(--color-surface) p-5 transition hover:border-(--color-brand)/50"
          >
            ...
            <p className="mt-3 text-sm leading-6 text-(--color-muted)">{guide.tagline}</p>
            <span className="mt-3 inline-flex items-center gap-1.5 text-sm font-semibold text-(--color-brand)">
